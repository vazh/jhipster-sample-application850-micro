...
import io.github.vazh.service.CountryQueryService;
...
/**
 * REST controller for managing {@link io.github.vazh.domain.Country}.
 */
@RestController
...
public class CountryResource {
    ...
    public ResponseEntity<CountryDTO> createCountry(@RequestBody CountryDTO countryDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/countries/" + countryDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, countryDTO.getId().toString()))
            .body(countryDTO);
    }
