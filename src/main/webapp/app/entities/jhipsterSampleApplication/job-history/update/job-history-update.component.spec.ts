...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 11033 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 8097 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 24956 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 17660 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 29415 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 27809 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 11403 };
      jobHistory.job = job;
      const department: IDepartment = { id: 22462 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 11618 };
      jobHistory.employee = employee;
