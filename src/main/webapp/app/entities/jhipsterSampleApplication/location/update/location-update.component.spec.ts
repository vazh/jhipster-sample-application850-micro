...
describe('Location Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, LocationUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call country query and add missing value', () => {
      ...
      const country: ICountry = { id: 7817 };
      location.country = country;

      const countryCollection: ICountry[] = [{ id: 27194 }];
    ...
    it('Should update editForm', () => {
      const location: ILocation = { id: 456 };
      const country: ICountry = { id: 26709 };
      location.country = country;
