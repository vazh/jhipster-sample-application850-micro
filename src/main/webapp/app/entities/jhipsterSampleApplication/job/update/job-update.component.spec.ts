...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 9282 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 30309 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 17463 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 26523 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 10550 };
      job.tasks = [task];
      const employee: IEmployee = { id: 5661 };
      job.employee = employee;
